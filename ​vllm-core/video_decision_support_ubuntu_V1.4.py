...
class AnomalyDetector:
    def __init__(self, fps=30.0):
        ...
        self.anomalies = []
        self._still_marked = set()   # bir kez "hareketsiz" dedigimiz track'ler
    ...
    def _check(self, tid, frame_idx, ts):
        ...
        cls = hist[-1]["cls"]
        # Kayitlar VID_STRIDE kadar gercek kare atlanarak geliyor.
        # 1 saniye ~= fps/stride kayit demek.
        eff_fps = max(self.fps / max(VID_STRIDE, 1), 1)
        window = max(int(eff_fps * 2), 3)          # ~2 saniyelik pencere, daha guvenilir
        # Hareketsizlik: piksel yayilimi cok dusukse VE bu track daha once
        # "Hareketsiz" olarak isaretlenmediyse
